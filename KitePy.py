...
mydb = mysql.connector.connect(
    host="database-1.cfyqg0kwq7od.ap-south-1.rds.amazonaws.com",       # Replace with your MySQL server hostname or IP address
    user="ancit",          # Replace with your MySQL username
    password="Ravi12345",      # Replace with your MySQL password
    database="kite_data"       # Replace with your MySQL database name
)
...
twofa = "476339"         # Login Pin or TOTP
